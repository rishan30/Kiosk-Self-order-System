...
<body style="background-color:rgb(255, 228, 235)" class="bodyyy">
...
<div class="bodyy">
    <div class="container my-4" id="cont" >
        ...
        <div class="col-md-12 my-5"><div class="card"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center">
            <br><br> <h2 style="font-size: 50px;color:black"><strong>Thank you ordering in KFC!</strong></h2><br><h2>Your order ID is </h2><h1 style="font-size: 160px;color:darkblue"><?php echo '#'.$orderID1; ?></h1> 
           ...
           <a href="index.php" class="btn btn-primary cart-btn-transform m-3" style="margin:90px; padding:10x 50px" data-abc="true"><h2>Got it</h2></a> 
