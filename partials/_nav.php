...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="position:relative;">
  ...
  echo '
  <ul style="padding-left:40px"><li class="nav-item active";>
  <a class="btn btn-sm btn-danger" style="padding:7px 30px"   href="index.php" align="right">  Exit  <span class="sr-only">(current)</span></a>
</li></ul></div>
    </nav>';
