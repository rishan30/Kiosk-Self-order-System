				...
				<table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            $sql = "SELECT * FROM users where id={$_SESSION['chefuserId']}"; 
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td>
                                    <td><img src="/kfc-kiosk/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/kfc-kiosk/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            <button class="btn btn-sm btn-primary"style="margin:5px 5px; width:100%;" data-toggle="modal" data-target="#editUser' .$Id. '" type="button">Edit</button>
                                                '
                                                ;
              ...
              <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Phone No" required pattern="[0-9]{9}" maxlength="9">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                ...
                <div class="form-group col-md-4">
                    <img src="/kfc-kiosk/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/kfc-kiosk/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
            ...
            <form action="partials/_userManage.php" method="post">
                ...
                <div class="form-group row my-0">
                    ...
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Type:</label></b>
                        <select name="userType" id="userType" class="custom-select browser-default" disabled>
                        <?php 
                            if($userType == 1) {
                        ?>
                            <option value="0">Chef</option>
                        ...
                        ?>
                            <option value="0" selected>Chef</option>
