...
<body style="background-color:rgb(255, 228, 235)">
    ...
    <div class="col-lg-4 text-center bg-light my-3" style="margin:auto;border-top: 2px groove black;border-bottom: 2px groove black;">     
            <h2 class="text-center" style="color:rgb(7, 102, 19); font-family: Verdana, Geneva, Tahoma, sans-serif;font-weight: 500;" ><span id="catTitle">Items</span></h2>
        </div>
        <div class="row" >
        <?php
            $id = $_GET['catid'];
            ...
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3" >
                        <div class="card" style="width: 17.5rem; margin:2px 5px">
                            ...
                            <div class="card-body">
                                ...
                                <h6 style="color: green"><b>Rs. '.$foodPrice. '/-</b></h6>
