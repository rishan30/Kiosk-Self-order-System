...
<body style="background-color:rgb(255, 228, 235)">
    ...
    <div class="container" id="cont">
        <div class="row" >
            ...
            <div class="col-lg-12 text-center border rounded bg-dark my-3">
                <h1 style="color:white ; font-family: Verdana, Geneva, Tahoma, sans-serif;">My Cart</h1>
            </div>
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td> <a href="#" data-toggle="modal" data-target="#Customize'. $foodId. '" class="view"><i class="material-icons">&#xE5C8;</i></a></td>
                                            <td>' . $custom. '</td>
            ...
            <strong>Info!</strong> Only Debit/Credit Card Payment Method is acceptible!.
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0 bg-light">GST(3%)<span>Rs.<?php echo (($totalPrice * 0.03)) ?></span></li>
