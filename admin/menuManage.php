			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Customize option 1: </label>
								<input type="text" class="form-control" name="opt1"
								default="none" >
							</div>
							<div class="form-group">
								<label class="control-label">Customize option 2: </label>
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/kfc-kiosk/img/food-'.$foodId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
...
<?php 
    ...
    while($foodRow = mysqli_fetch_assoc($foodResult)){
		...
		$foodopt1=$foodRow['custom1'];
		$foodopt2=$foodRow['custom2'];
?>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/kfc-kiosk/img/food-<?php echo $foodId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
			...
			<div class="text-left my-2">
                <b><label for="opt1">Customize option 1</label></b>
                <input class="form-control" id="opt1" name="opt1" value="<?php echo $foodopt1; ?>" type="text" default="none">
            </div>
			<div class="text-left my-2">
                <b><label for="opt2">Customize option 2</label></b>
                <input class="form-control" id="opt2" name="opt2" value="<?php echo $foodopt2; ?>" type="text" default="none">
            </div>
            <div class="text-left my-2">
